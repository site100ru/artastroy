                ...
                <nav id="contacts-menu-1" class="navbar-light">
                    ...
                    <div class="row h-100 justify-content-center align-items-center d-none d-lg-flex">
                        ...
                        <div class="col-4 col-lg-2">
                            <a class="navbar-brand" href="<?php echo esc_url(home_url('/')); ?>">
                                <img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/ico/<?php echo esc_attr($logo_ico); ?>"
                                    id="navbar-brand-img"
                        ...
                        <div class="col-2 text-end d-flex gap-3">
                            <?php if (!empty($all_phones)) : ?>
                                <img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/ico/<?php echo esc_attr($tel_ico); ?>" alt="">
                                <div>
                    ...
                    <div class="row d-lg-none">
                        <div class="col-6">
                            <a class="navbar-brand" href="<?php echo esc_url(home_url('/')); ?>">
                                <img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/ico/<?php echo esc_attr($logo_ico); ?>"
                                    class="me-3" id="navbar-brand-img"
                                    alt="<?php bloginfo('name'); ?>">
                            </a>
                        </div>
                ...
                <ul class="nav justify-content-center flex-column flex-lg-row">
                        ...
                        <li class="nav-item me-1 me-lg-5">
                            <a class="nav-link">
                                <div class="d-flex align-items-center gap-3 lh-1">
                                    <img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/ico/<?php echo esc_attr($loc_ico); ?>" class="mobile-ico" alt="">
                    ...
                    <?php if ($job_time) : ?>
                        <li class="nav-item me-1 me-lg-5">
                            <a class="nav-link">
                                <div class="d-flex align-items-center gap-3 lh-1">
                                    <img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/ico/<?php echo esc_attr($clk_ico); ?>" class="mobile-ico" alt="">
                    ...
                    <?php if ($email) : ?>
                        <li class="nav-item me-1 me-lg-5">
                            <a class="nav-link" href="mailto:<?php echo esc_attr($email); ?>">
                                <div class="d-flex align-items-center gap-3 lh-1">
                                    <img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/ico/<?php echo esc_attr($eml_ico); ?>" class="mobile-ico" alt="">
                    ...
                    <?php if ($vk) : ?>
                        <li class="nav-item">
                            <a class="nav-link ico-button" href="<?php echo esc_url($vk); ?>">
                                <img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/ico/vider-circle-ico.svg" alt="ВКонтакте">
                            </a>
                        </li>
                    <?php endif; ?>
                    <?php if ($max_link) : ?>
            ...
            <div class="row">
                <div class="col text-start text-md-center" id="im-in-footer">
                    ...
                    <div class="policy-in-footer">
                        <a class="links-one"
                            href="<?php echo esc_url(get_template_directory_uri()); ?>/docs/Privacy-Policy.pdf"
...
<div class="modal fade" id="orderModal" tabindex="-1" aria-labelledby="orderModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <form method="post"
            action="<?php echo esc_url(get_template_directory_uri()); ?>/mails/order-product-mail.php"
            class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-6 col-md-5">
                        ...
                        <input type="text" name="name" class="order-form-input order-form-input-dark mb-3 mb-md-0" id="orderName" placeholder="Ваше имя">
                    </div>
                    <div class="col-6 col-md-5">
                        <label for="orderPhone" class="order-form-label d-none">Ваш телефон*</label>
                        <input type="text" name="phone" class="order-form-input order-form-input-dark mb-3 mb-md-0 telMask" id="orderPhone" inputmode="text" placeholder="Ваш телефон*">
                    </div>
                </div>
