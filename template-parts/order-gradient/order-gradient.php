...
<section class="section order-left-gradient-section bg-corporate-alt">
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-md-6 col-xl-5 order-left-gradient-content">
                ...
                <form method="post" action="<?php echo esc_attr($action); ?>"> 
                    <div class="row">
                        <div class="col-6 col-md-5">
                            ...
                            <input type="text" name="name" class="order-form-input mb-3 mb-md-0 order-form-input-dark" id="order-gradient-name">
                        </div>
                        <div class="col-6 col-md-5">
                            <label for="order-gradient-phone" class="order-form-label">Ваш телефон*</label>
                            <input type="text" name="phone" class="order-form-input mb-3 mb-md-0 order-form-input-dark telMask" id="order-gradient-phone" inputmode="text" required>
                        </div>
                    </div>
                    <div class="row mt-md-3">
                        <div class="col-6 col-md-7 col-lg-5">
                            <button type="submit" class="btn btn-corporate-color-1 btn-corporate-color-2 mt-md-3 w-100">
