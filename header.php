...
<head>
    ...
    <link href="<?php echo get_template_directory_uri(); ?>/css/bootstrap.min.css" rel="stylesheet" crossorigin="anonymous">
    ...
    <noscript>
        <div><img src="https://mc.yandex.ru/watch/95629828" style="position:absolute; left:-9999px;" alt="" /></div>
    </noscript>
    <!-- /Yandex.Metrika counter -->
    <?php wp_head(); ?>
</head>
    ...
    <header class="header-white">
                        ...
                        <?php if ($email) : ?>
                            <li class="nav-item me-1 me-xxl-4">
                                <a class="nav-link" href="mailto:<?php echo esc_attr($email); ?>">
                                    <div class="d-flex align-items-center gap-2">
                                        <img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/ico/email-ico.svg" alt="" class="mobile-ico">
                        ...
                        <?php foreach ($all_phones as $phone) : ?>
                            <li class="nav-item me-1 me-xxl-4">
                                <a class="top-menu-tel nav-link" href="tel:<?php echo esc_attr($phone['link']); ?>">
                                    <div class="d-flex align-items-center gap-2">
                                        <img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/ico/mobile-phone-ico.svg" alt="" class="mobile-ico">
        ...
        <nav class="header-nav-bottom navbar navbar-expand-lg navbar-light bg-white shadow">
            <div class="container">
                ...
                <!-- Логотип -->
                <a class="navbar-brand" href="<?php echo esc_url(home_url('/')); ?>" style="white-space: normal; margin-right: 0;">
                    <div id="header-logo" style="display: flex; align-items: center; transition: .25s;">
                        <img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/ico/logo-dark.svg" id="navbar-brand-img" alt="<?php bloginfo('name'); ?>">
                    </div>
                </a>
                    ...
                    <div class="nav-item d-lg-none py-2 mt-2">
                        ...
                        <?php if ($address) : ?>
                            <div class="d-flex align-items-center gap-2 mobile-sliding-header-time">
                                <img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/ico/location-ico-dark.svg" alt="" class="mobile-ico">
                                <span class="address-footer"><?php echo mytheme_kses_br($address); ?></span>
                            </div>
                        <?php endif; ?>
                        ...
                        <?php foreach ($all_phones as $phone) : ?>
                            <div class="mobile-sliding-header-time">
                                <a class="nav-link py-2 d-flex align-items-center gap-2" href="tel:<?php echo esc_attr($phone['link']); ?>">
                                    <img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/ico/mobile-phone-ico-dark.svg" alt="" class="mobile-ico">
                        ...
                        <?php if ($job_time) : ?>
                            <div class="d-flex align-items-center gap-2 mobile-sliding-header-time">
                                <img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/ico/clock-ico-dark.svg" alt="" class="mobile-ico">
                                <span class="time-footer"><?php echo mytheme_kses_br($job_time); ?></span>
                            </div>
                        <?php endif; ?>
